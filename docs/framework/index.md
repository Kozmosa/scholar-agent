...
> [!abstract]
> 这一组笔记用于说明 `scholar-agent` 当前关于研究任务控制面、模式基线和实现边界的长期文档。当前阅读入口已经从早期“bounded-autonomous orchestrator / WebUI-v1”主叙事，收敛为“单用户优先、task-centric、evidence-grounded 的 research dashboard next release”。
...
- 先读 [[framework/ai-native-research-framework]]，确认项目当前定位、长期方向、当前范围和非目标。
- 再读 [[LLM-Working/refactoring-plan/index]]，进入本轮 requirements / expectations 重对齐文档集。
